    ...
    return Dismissible(
      ...
      onDismissed: (direction) async {
        ...
        await BlocProvider.of<DeleteMessageCubit>(context).deleteMessage(
            messagesList![itemIndex].msgId!, box.get(kEmployeeDataBox)!.userId);
      ...
      child: Column(
        children: [
          FadeInLeft(
            child: Card(
              // elevation:
              //     messagesList![itemIndex].toUsers![0].seen == "0"
              //         ? 1
              //         : 0,
              child: ListTile(
                subtitle: Text(
          ...
          // Divider(
          //   height: 7,
          //   thickness: messagesList![itemIndex].toUsers![itemIndex].seen == "0"
          //       ? 0
          //       : 1,
          // ),
        ],
