...
import 'package:HrmsVersions/Features/messages/my_messages/data/models/delete_message_model.dart';
import 'package:HrmsVersions/Features/messages/my_messages/domain/entities/delete_message_entity.dart';
    ...
    await getIt<NetworkRequest>().requestFutureData<DeleteMessageModel>(
      ...
      onSuccess: (data) {
        if (data.status == 200) {
          ...
          deleteMessageResponse = left(data.toString());
        }
      },
      onError: (code, msg) {
